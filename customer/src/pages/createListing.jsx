  ...
  const handleImageSubmit = (e) =>
  {
    if(files.length > 0 && files.length + formData.imageUrls.length < 7)
    {
      ...
      .then((urls)=> 
      {
        setFormData({
          ...formData, 
          imagesUrls: formData.imageUrls.concat(urls)
        });
          setImageUploadError(false);
          setUploading(false)
          })
  ...
  const handleRemoveImage =(index) =>{
    ...
    return (
      <main 
        ...
        text-centre my-7'>Create a Listing</h1>
        <form 
            ...
            <div 
              className='flex item-center gap-2'>
                <input 
                  ...
                  min='1' 
                  max='10' 
                  required className='p-3 border border- 
                  gray-300 rounded-lg'
                  onChange={handleChange} 
      ...
      <div 
        ...
        <p 
          ...
          Images:
          <span 
          className='font-normal text-gray-600 ml- 
          2'>The image will be the cover (max 6)
          </span>
        </p>
        <div 
          className='flex ga-4'>
          ...
          <button 
            ...
            className='p-3 text-green-700 border border- 
            green-700 rounded uppercase 
        ...
        <button 
          ...
          lg uppercase hover:opacity-95 disabled:opacity- 
          80'>
