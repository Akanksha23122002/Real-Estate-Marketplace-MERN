...
export default function CreateListing(){
    ...
    <main className= 'p-3 max-w-4xl mx-auto'>
        ...
        id='name' maxLength='62' minLength='10' 
         required />
         <textarea type="text" placeholder='Discription' 
        className='border p-3 rounded-lg' 
        ...
        <div className="flex gap-6 flex-wrap">
            ...
            <div className='flex item-center gap-2'>
                <input type="number" id="discount" min='1' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
       ...
       <div className='flex flex-col flex-1 gap-4'>
          ...
          <span className='font-normal text-gray-600 ml-2'>The image will be the cover (max)</span>
          </p>
